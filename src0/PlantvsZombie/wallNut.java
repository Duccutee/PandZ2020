...
public class wallNut extends Vegan {
	...
	//BufferedImage wallNutImage,brokenNut, broken,trans1,trans2,trans3,image;
	...
	public wallNut(int x, int y,int width, int height) {
		...
		try {
			...
			e.printStackTrace();}
	/*	try {
			wallNutImage = ImageIO.read(new File("ImageSource\\PlantImage\\wallNut1.png") );
			trans1 = ImageIO.read(new File("ImageSource\\PlantImage\\wallNut2.png") );
			brokenNut = ImageIO.read(new File("ImageSource\\PlantImage\\wallNut3.png") );
			trans2 = ImageIO.read(new File("ImageSource\\PlantImage\\wallNut4.png") );
			broken = ImageIO.read(new File("ImageSource\\PlantImage\\wallNut5.png") );
			trans3 = ImageIO.read(new File("ImageSource\\PlantImage\\wallNut6.png") );
